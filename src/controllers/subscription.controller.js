...
const getUserChannelSubscribers = asynHandler(async (req, res) => {
    ...
    try {
        ...
        return res.status(200)
        .json( new ApiResponse(200,channelSubscribers,"Total number of subscriber"))

    } catch (error) {
        throw new ApiError(500, error?.message, "Error while returning total number of subscriber.")
    }
...
const getSubscribedChannels = asynHandler(async (req, res) => {
    ...
    try {
        ...
        return res.status(200)
        .json( new ApiResponse(200,susbcriberChannels,"Total number of Channels"))

    } catch (error) {
        throw new ApiError(500, error?.message, "Error while returning total number of channels.")
    }
